                  ...
                  <div class="row">
                    <div class="col-menu col-md-6">
                      ...
                      <div class="content">
                        <ul class="menu-col">
                          <li>
                            <router-link :to="{ path: '/admin/users/approved' }">Approved</router-link>
                          </li>
                          <li>
                            <router-link :to="{ path: '/admin/users/rejected' }">Rejected</router-link>
                          </li>
                          <li>
                            <router-link :to="{ path: '/admin/users/pending' }">Pending</router-link>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="col-menu col-md-6">
                      ...
                      <div class="content">
                        <ul class="menu-col">
                          <li>
                            <router-link :to="{ path: '/admin/export/json' }">JSON</router-link>
                          </li>
                          <li>
